package com.rk.sk_recyclerview_sederhana__jvm.data;
...
public class HeroesData {
    ...
    public static ArrayList<Hero> dapatkanDaftarData() {
        ArrayList<Hero> daftar = new ArrayList<>();

        for (int posisi = 0; posisi < heroNames.length; posisi++) {
            Hero pahlawan = new Hero();
            pahlawan.setNama(heroNames[posisi]);
            pahlawan.setRincian(heroDetails[posisi]);
            pahlawan.setFoto(heroesImages[posisi]);
            daftar.add(pahlawan);
        }
